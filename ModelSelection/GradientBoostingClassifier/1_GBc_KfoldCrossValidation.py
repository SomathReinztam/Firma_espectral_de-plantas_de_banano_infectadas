...
hyperparameter = {'loss': 'log_loss', 'n_estimators': 900, 'criterion': 'squared_error', 'max_depth': 9, 'max_features': 'sqrt'}
print('hyper parameters: {}'.format(hyperparameter))
print()

clf = GradientBoostingClassifier(**hyperparameter)
