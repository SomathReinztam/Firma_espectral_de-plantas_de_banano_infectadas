...
hyperparameter = {'n_estimators': 800, 'max_depth': 11, 'criterion': 'entropy', 'max_features': 'sqrt'}
print('hyper parameters: {}'.format(hyperparameter))
print()

clf = RandomForestClassifier(**hyperparameter)
